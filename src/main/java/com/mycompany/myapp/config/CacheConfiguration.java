...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.LoginResponseData.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.UserData.class.getName(), jcacheConfiguration);
